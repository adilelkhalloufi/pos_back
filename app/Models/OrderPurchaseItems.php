...
class OrderPurchaseItems extends BaseModel
{
    ...
    public const COL_RECEIVED_QUANTITY = 'received_quantity';
    ...
    /**
     * Get all delivery items for this purchase item
     */
    public function deliveryItems()
    {
        return $this->hasMany(PurchaseDeliveryItem::class, 'order_purchase_item_id');
    }
}
