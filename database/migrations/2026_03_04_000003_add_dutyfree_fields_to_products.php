...
return new class() extends Migration
{
    public function up(): void
    {
        Schema::table('products', function (Blueprint $table) {
            ...
            $table->decimal('price_buy', 10, 4)->nullable()->after('price')->comment('PA — purchase price / cost');
            $table->decimal('price_sell_1', 10, 4)->nullable()->after('price_buy')->comment('PV1 — main selling price');
            $table->decimal('price_sell_2', 10, 4)->nullable()->after('price_sell_1')->comment('PV2 — second selling price');
    ...
    public function down(): void
    {
        Schema::table('products', function (Blueprint $table) {
            ...
            $table->dropColumn(['supplier_code', 'price_buy', 'price_sell_1', 'price_sell_2', 'is_stockable']);
        });
    }
};
